        ...
        <div id='project_container'>
            ...
            <div className='project_wrapper'>
                <div className='project'>
                    <h3>Zorkington</h3>
                    <img src='images/zorkington.png' alt="Zorkington" />
                    <div>
                ...
                <div className='project'>
                    <h3>Tic Tac Toe</h3>
                    <img src='images/Tic Tac Toe.png' alt="Tic Tac Toe App" />
                    <div>
                ...
                <div className='project'>
                    <h3>Geo Vermonter</h3>
                    <img src='images/geo_vermonter.png' alt="Geo Vermonter" />
                    <div>
                ...
                <div className='project'>
                    <h3>Yelpington</h3>
                    <img src='images/yelpington.png' alt="Yelington" />
                    <div>
