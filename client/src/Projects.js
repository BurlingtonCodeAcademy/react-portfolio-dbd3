...
function Projects(props) {
    ...
    return (
        <div id='project_container'>
            ...
            <div id='project'>
                <h3>Zorkington</h3>
                <img src='zorkington.png' alt="Zorkington"/>
                <div>
            ...
            <div id='project'>
                <h3>Tic Tac Toe</h3>
                <img src='Tic Tac Toe.png' alt="Tic Tac Toe App"/>
                <div>
            ...
            <div id='project'>
                <h3>Geo Vermonter</h3>
                <img src='geo_vermonter.png' alt="Geo Vermonter"/>
                <div>
            ...
            <div id='project'>
                <h3>Yelpington</h3>
                <img src='yelpington.png' alt="Yelington"/>
                <div>
